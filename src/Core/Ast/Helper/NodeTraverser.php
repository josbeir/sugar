...
final class NodeTraverser
{
     ...
     * ```
     *
     * @param array<\Sugar\Core\Ast\Node> $nodes Nodes to traverse
     * @param callable(\Sugar\Core\Ast\Node, callable(\Sugar\Core\Ast\Node): \Sugar\Core\Ast\Node): (\Sugar\Core\Ast\Node|array<\Sugar\Core\Ast\Node>) $visitor Visitor function
     * @return array<\Sugar\Core\Ast\Node> Transformed nodes
     */
     ...
     * ```
     *
     * @param \Sugar\Core\Ast\Node $node Root node to start traversal
     * @param callable(\Sugar\Core\Ast\Node): void $visitor Visitor function (no return value)
     */
     ...
     *
     * @param \Sugar\Core\Ast\Node $root Root node to search from
     * @param callable(\Sugar\Core\Ast\Node): bool $predicate Test function
     * @return \Sugar\Core\Ast\Node|null First matching node or null
     */
     ...
     * @param \Sugar\Core\Ast\Node $root Root node to search from
     * @param callable(\Sugar\Core\Ast\Node): bool $predicate Test function
     * @return array<\Sugar\Core\Ast\Node> All matching nodes
     */
