...
final class FileCache implements TemplateCacheInterface
{
     ...
     * @return \Sugar\Core\Cache\CacheMetadata Metadata object
     */
     ...
     *
     * @param string $path Metadata file path
     * @param \Sugar\Core\Cache\CacheMetadata $metadata Metadata to save
     */
     ...
     *
     * @param \Sugar\Core\Cache\CacheMetadata $metadata Cache metadata
