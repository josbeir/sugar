...
final class CompilationContext
{
     ...
     * @param \Sugar\Core\Cache\DependencyTracker|null $tracker Dependency tracker for cache invalidation
     ...
     *
     * @param class-string<\Sugar\Core\Exception\SugarException> $exceptionClass Exception class to instantiate
     * @param string $message Error message
     * @param int|null $line Line number in template
     * @param int|null $column Column number in template
     * @return \Sugar\Core\Exception\SugarException The created exception
     */
    ...
    public function createSyntaxException(
        ...
        /** @var \Sugar\Core\Exception\SyntaxException $exception */
        return $exception;
    }
     ...
     * @param class-string<\Sugar\Core\Exception\SugarException> $exceptionClass Exception class to instantiate
     * @param string $message Error message
     * @param \Sugar\Core\Ast\Node $node Node providing location metadata
     ...
     * @param class-string<\Sugar\Core\Exception\SugarException> $exceptionClass Exception class to instantiate
     * @param string $message Error message
     * @param \Sugar\Core\Ast\AttributeNode $attribute Attribute providing location metadata
     * @param int|null $line Line number override
     * @param int|null $column Column number override
     * @return \Sugar\Core\Exception\SugarException The created exception
     */
