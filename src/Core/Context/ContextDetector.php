...
final class ContextDetector implements ContextDetectorInterface
{
     ...
     * @return \Sugar\Core\Enum\OutputContext The detected output context
     */
     ...
     * @return \Sugar\Core\Enum\State The parser state
     */
    ...
    private function isInTag(int $position, string $source): bool
    {
         ...
         * @param string $source Template source
         * @return \Sugar\Core\Context\OutputContext The detected context
         */
     ...
     * @param int $position Position in attribute
     * @param string $source Template source
     * @return \Sugar\Core\Enum\OutputContext The detected context
     */
