...
final readonly class Parser
{
     ...
     *
     * @param array<\Sugar\Core\Parser\SugarToken> $tokens Token stream
     ...
     * @return array<\Sugar\Core\Ast\Node|\Sugar\Core\Parser\ClosingTagMarker> Flat node list
     */
     ...
     * @param int $line Line number
     * @param int $column Column number
     * @return array{0: \Sugar\Core\Ast\ElementNode, 1: int} Element and position after tag
     */
     ...
     *
     * @param array<\Sugar\Core\Ast\Node|\Sugar\Core\Parser\ClosingTagMarker> $flatNodes Flat list
