 ...
 * ```php
 * <?php $__tag_HASH = \Sugar\Runtime\HtmlTagHelper::validateTagName($headingLevel); ?>
 ...
 */
readonly class TagCompiler implements DirectiveCompilerInterface, ElementExtractionInterface
{
    /**
