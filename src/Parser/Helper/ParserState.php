...
{
    /**
     * @var array<\Sugar\Ast\Node|\Sugar\Parser\Helper\ClosingTagMarker>
     */
    private array $nodes = [];

    /**
     * @var array{element: \Sugar\Ast\ElementNode, attrIndex: int, quote: string|null}|null
     */
    private ?array $pendingAttribute = null;

    /**
     * @param \Sugar\Parser\Helper\TokenStream $stream Token stream
    ...
    /**
     * @return array<\Sugar\Ast\Node|\Sugar\Parser\Helper\ClosingTagMarker>
     */
    ...
    /**
     * @param array{element: \Sugar\Ast\ElementNode, attrIndex: int, quote: string|null}|null $pendingAttribute
     */
